...
export const TEST_PKM_DETAIL__NUMBER = 'detail__number';
export const TEST_PKM_DETAIL__NAME = 'detail__name';
export const TEST_PKM_DETAIL__TYPE_LABEL = 'detail__type-label';
